...
let firstNum, operatorForAdvanced, previousKey, previousNum, previousStr;
  ...
  if (target.matches('button')) {
    ...
    if (action === 'number') {
      if (display.textContent === '0' || previousKey === 'calculate') {
        ...
        pro.textContent = display.textContent;
      } 

      else if (previousKey==='operator') {
        display.textContent = buttonContent;
        pro.textContent = pro.textContent+buttonContent;
      }
    ...
    if (action === 'operator') {
      ...
      pro.textContent = firstNum + operatorForAdvanced;
    ...
    if (action === 'calculate') {
      if (firstNum) {
        ...
        pro.textContent=`${pro.textContent}=`
      }
